...
const SplashScreen: React.FC<SplashScreenProps> = ({ onComplete }) => {
  ...
  useEffect(() => {
    ...
    let minDisplayTime = 2000 // Минимальное время показа - 2 секунды
    ...
    if (video) {
      ...
      // Fallback: если видео не загрузилось или не закончилось за 8 секунд
      ...
      // Fallback без видео - минимум 2 секунды
  ...
  return (
    <div className={`splash-screen ${fadeOut ? 'fade-out' : ''}`}>
      <video
        ...
        preload="auto"
      >
        <source src="/animations/prv_green0001-0125.mov" type="video/quicktime" />
        <source src="/animations/prv_green0001-0125.mp4" type="video/mp4" />
      </video>
      <div className="splash-logo">
        <img src="/src/Resources/Splash/splash.svg" alt="Yess" style={{ width: 120, height: 120, opacity: 0.3 }} />
      </div>
