  ...
  const socialNetworks = [
    {
      ...
      name: '@Yess!Go_Bisha',
      icon: (
        <div className="social-whatsapp-icon">
    ...
    <div className="social-page">
      <div className="social-header">
        <div className="social-header-icon-wrapper">
          <ShareAltOutlined className="social-header-icon" />
          <div className="social-header-overlay">
            <ShareAltOutlined className="social-header-overlay-icon" />
          </div>
        </div>
        ...
        {socialNetworks.map((network) => (
          ...
          >
            <div className="social-card-content">
              <div className="social-icon-wrapper">{network.icon}</div>
